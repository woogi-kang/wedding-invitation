  ...
  interview: [
    {
      ...
      brideAnswer:
        '회사 회의에서 처음 만났는데 오류에 대해 치열하게 논쟁하던 모습이 아직도 기억납니다. 그런데 막상 업무요청하니까 친절하고 아주 번개처럼 처리해주는거에요, 프로페셔널함에 감동 받았는데 그냥 저의 마음을 얻기 위해 제 요청에 열심이었던 것으로 밝혀졌습니다.',
    },
    {
    ...
    },
    {
      ...
      groomAnswer:
        '하객분들은 선경이의 당차고 강한 모습만 보셨을 텐데, 저한테는 울거나 투정 부리는 모습을 보여주는 사람이에요. 그런데 그게 저한테만 보여주는 모습이라는 걸 알기에, 제 앞에서만큼은 안심하고 약해져도 되는, 그런 남편이 되고 싶습니다.',
      brideAnswer:
