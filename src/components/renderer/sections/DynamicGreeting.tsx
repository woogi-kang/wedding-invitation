...
import type { DynamicGreetingProps } from '../types';

export function DynamicGreeting({ greetingMessage }: DynamicGreetingProps) {
    ...
    <Section id="greeting" background="white">
      <div ref={sectionRef} className="max-w-md mx-auto text-center">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <svg className="w-8 h-8 mx-auto mb-4" viewBox="0 0 24 24" fill="none" style={{ color: 'var(--color-gold)' }}>
            <path
