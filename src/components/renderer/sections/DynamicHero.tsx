...
import type { DynamicHeroProps } from '../types';
    ...
    <section className="relative min-h-screen overflow-hidden bg-[var(--color-background)]">
      ...
      >
        <div
          ...
          role="img"
          aria-label="커플 사진"
          style={{ backgroundImage: `url(${heroImages.couple})`, willChange: 'auto' }}
        />
      ...
      <div className="absolute inset-0 hidden sm:flex">
        ...
        >
          <div
            ...
            role="img"
            aria-label="신랑 사진"
            style={{ backgroundImage: `url(${heroImages.groom})`, willChange: 'auto' }}
          />
        ...
        >
          <div
            ...
            role="img"
            aria-label="신부 사진"
            style={{ backgroundImage: `url(${heroImages.bride})`, willChange: 'auto' }}
          />
      ...
      >
        ...
        >
          ...
          >
            <p className="text-base min-[375px]:text-lg sm:text-xl mb-1 sm:mb-2 tracking-wider" style={heroTextHeading}>
              {dateDisplay.year}. {String(dateDisplay.month).padStart(2, '0')}. {String(dateDisplay.day).padStart(2, '0')}
            </p>
            <p className="text-xs sm:text-sm tracking-wider" style={heroTextHeading}>
