        ...
        <TerminalWindow title="location.config.ts">
          <div className="space-y-4">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative h-40 sm:h-48 bg-[#0a0a0a] rounded border border-[#00ff41]/30 overflow-hidden"
            >
              {/* Grid Pattern */}
              <div
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
              {[
                ...
                <motion.button
                  ...
                  className="px-2 py-2.5 sm:px-3 border rounded font-mono text-[10px] sm:text-xs transition-colors"
                  style={{
